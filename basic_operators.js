...
// ? The first expression 1+2 is evaluated and its result is thrown away, Then, 3+4 IS evaluated and the returned as the result.

let aa = 1,
    bb1 = 1

let cc = ++aa // ? prefix form returns the new value
let d = bb1++ // ? postfix from returns the old value
